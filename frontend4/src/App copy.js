...
import SimulationPage from './pages/SimulationPage'; // Import SimulationPage
import GenerateReport from './pages/GenerateReport';  // Import GenerateReport
    ...
    return (
        <div className="container">
            <Routes>
                ...
                <Route
                    path="/simulation"
                    element={isLoggedIn ? <SimulationPage /> : <Navigate to="/login" />} // Add SimulationPage route here
                />
                 <Route
                    path="/generate-report"
                    element={isLoggedIn ? <GenerateReport /> : <Navigate to="/login" />}
                />
            </Routes>
        </div>
    );
